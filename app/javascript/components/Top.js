...
class Top extends React.Component {
  ...
  render () {
    ...
    return(
      <React.Fragment>
        {signed_in &&
          <Navbar className="navbar navbar-expand-md navbar-collapse-xs navbar-dark bg-primary sticky-nav mb-4">
            <NavbarBrand href="/">
              <img 
                id="imageSrc" 
                src={Logo} 
        ...
        {!signed_in &&
          <Navbar className="navbar navbar-expand-md navbar-collapse-xs navbar-dark bg-primary mb-4">
            <NavbarBrand href="/">
              <img 
                id="imageSrc" 
                src={Logo} 
