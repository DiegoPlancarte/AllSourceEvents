...
export class EditVendor extends Component {
    ...
    super(props)
      this.state = {
        ...
        form:{
          ...
          vendor_id: props.match.params.id
        }
      }
  }
  ...
  setForm = () => {
    ...
    const vendor = vendors.find((a)=> a.id === parseInt(form.vendor_id))
    this.setState({form: vendor})
  }
        ...
        <Row>
          <Container sm={6} id="form">
            ...
            <Form>
              ...
              {this.state.success && <Redirect to="/allvendors"/>}
              <Link to="/allvendors" className="btn btn-primary" onClick={this.handleEdit}>
                Submit
              </Link>
          </Container>
        </Row>
